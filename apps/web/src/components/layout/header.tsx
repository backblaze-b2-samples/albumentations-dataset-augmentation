...
// Section label for the leading path segment — used so deep dynamic routes
// (e.g. "/recipes/abc123" or "/runs/r1/run9") read as their section name
// rather than title-casing a raw id into the breadcrumb.
...
// Fallback page label for routes not in the override map: prefer the section
// label of the first segment; otherwise title-case the last non-empty segment,
// splitting hyphens (e.g. "/file-browser" -> "File Browser").

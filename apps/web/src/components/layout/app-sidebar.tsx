...
const navItems = [
  ...
  { title: "Recipes", href: "/recipes", icon: Layers },
  ...
  return (
    <Sidebar>
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {navItems.map((item) => {
                // Highlight a section while on any of its sub-routes
                // (e.g. "/recipes/abc" keeps "Recipes" active).
                const isActive =
                  pathname === item.href ||
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-albumentations-dataset-augmentation-pipeline"
          target="_blank"
